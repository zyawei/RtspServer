...
public class Session {
    ...
    public boolean equals(Object o) {
        ...
        return mTimeToLive == session.mTimeToLive &&
                mTimestamp == session.mTimestamp &&
                Objects.equals(mOrigin, session.mOrigin) &&
                Objects.equals(mDestination, session.mDestination) &&
                Objects.equals(mAudioStream, session.mAudioStream) &&
                Objects.equals(mVideoStream, session.mVideoStream) &&
                Objects.equals(mCallback, session.mCallback) &&
                Objects.equals(mMainHandler, session.mMainHandler) &&
                Objects.equals(mUpdateBitrate, session.mUpdateBitrate);
    }

    @Override
    public int hashCode() {
        return Objects.hash(mOrigin, mDestination, mTimeToLive, mTimestamp, mAudioStream, mVideoStream, mCallback, mMainHandler, mUpdateBitrate);
    }
}
